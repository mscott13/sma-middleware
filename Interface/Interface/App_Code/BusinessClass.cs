...
namespace _000.App_Code
{
    ...
    public class BusinessClass
    {
        ...
        public static int InsertBudgetInfo(string CustomerID, Decimal  budget, int invoiceid)
        {
            try
            {
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Integrationn"].ConnectionString);
        ...
        [DataObjectMethod(DataObjectMethodType.Insert)]
        public static int UpdateBudgetInfo(int invoiceid, Decimal budget)
        {
            try
            {
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Integrationn"].ConnectionString);
        ...
        public static DataSet GetDefferdInfo()
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["AsmsDev"].ConnectionString);
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public static Interface.ReturnData GetTypeApprovalInvoicesFormonth(int month, int year)
        {
            try
            {
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public static Interface.ReturnData GetRegInvoicesFormonth(int month, int year)
        {
            try
            {
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public static Interface.ReturnData GetSpecInvoicesFormonth(int month, int year)
        {
            try
            {
        ...
        public static Interface.ReturnData refineDataset(DataSet ds)
        {
            int 
                invoiceCount = 0;
            decimal totalAmount = 0;
            Interface.ReturnData rData = new Interface.ReturnData();
            ...
            List<Interface.InvoiceList> iList = new List<Interface.InvoiceList>();
            foreach(DataRow row in ds.Tables[0].Rows)
            {
                ...
                {
                    Interface.InvoiceList iData = new Interface.InvoiceList();
        ...
        public static int checkListRecordAvail(int invoiceId, List<Interface.InvoiceList> iList)
        {
            if (iList.Count == 0)
            {
                return -1;
